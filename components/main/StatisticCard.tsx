...
function StatisticCard() {
  return (
    <div className='border-[1.7px] rounded-2xl border-gray-300 h-60 mt-12 max-w-[104rem] mx-auto flex justify-evenly items-center'>
      <div className='flex flex-col items-center justify-center text-3xl gap-2 font-extrabold text-cyan-700'>
      ...
      <div className='flex flex-col items-center justify-center border-r-2 border-l-2 px-[10%] border-gray-300 text-3xl gap-2 font-extrabold text-cyan-700'>
