  ...
  return (
    <Link href='/jobs/id'>
      <div className='border-[2px] rounded-2xl border-gray-300 px-10 pt-8 pb-12 hover:border-blue-800 transition-all cursor-pointer'>
        <p className='text-2xl font-bold tracking-wider text-blue-900 mb-3 opacity-90'>
        ...
        {/* slice length to 200 characters */}
        <p className='mt-6 mb-4 text-gray-500 tracking-wider text-[15px] leading-7'>
          We are a lively and diverse team, founded by our CEO Julian Weselek in
          2016, currently active in Germany and France. Our ambition is to
          become the leading travel company for authentic, customize in...
        </p>
