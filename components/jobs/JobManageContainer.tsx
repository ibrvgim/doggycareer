    ...
    <div className='mt-8 flex flex-col items-start'>
      ...
      <div className='mt-5 flex flex-wrap gap-3'>
        <form action={repostJob}>
          ...
          <Button style='bg-neutral-500 text-white border-neutral-500 hover:bg-neutral-600'>
            Re - Post
          </Button>
        </form>
        ...
        <Link
          ...
          className='border-[1px] rounded-full tracking-widest min-w-48 py-0 px-4 font-semibold bg-cyan-600 text-white border-cyan-600 hover:bg-cyan-700 text-center transition-all'
        >
          Edit
        </Link>
        ...
        <form action={deleteJob}>
          <input name='jobId' value={jobId} className='hidden' hidden />
          <Button style='bg-red-500 text-white border-red-600 hover:bg-red-700'>
            Delete
          </Button>
        </form>
      </div>
