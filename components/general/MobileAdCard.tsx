...
function MobileAdCard() {
  return (
    <section className='rounded-3xl min-h-[25rem] max-w-[104rem] mx-auto bg-gradient-to-r from-blue-200 via-rose-200 to-yellow-50 px-24 py-16 flex mt-36 mb-16 gap-32 justify-center'>
      <Image
        src={QRCodeImage}
        alt='qr-code image'
        width={250}
      ...
      <div>
        <p className='text-5xl font-extrabold uppercase tracking-widest text-cyan-600 leading-snug'>
